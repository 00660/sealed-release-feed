...
Examples:
  curl -fsSL https://github.com/00660/sealed-release-feed/raw/refs/heads/主要/install.sh | sudo bash -s --

  curl -fsSL https://github.com/00660/sealed-release-feed/raw/refs/heads/主要/install.sh | \
